...
class TicketsApi {
    ...
    async getSchedules(date = moment().format('YYYY-MM-DD'), dateEnd = moment().format('YYYY-MM-DD')) {
        try {
            ...
            console.log(clc.cyan.bgWhite.blink(`ОТВЕТ РАСПИСАНИЯ ${moment().format('YYYY-MM-DD hh:mm:ss a')}`));
    ...
    async updateAuthToken() {
        try {
            ...
            console.log(clc.cyan.bgWhite.bold(`Токен получен ${moment().format('YYYY-MM-DD hh:mm:ss a')}`));
